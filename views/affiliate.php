		...
		echo'<div id="media_library">';
			...
			echo'<div class="col-xs-3 col-sm-2">';
				...
				echo'<ul class="nav nav-tabs tabs-left">';
					...
					echo'<li><a href="#agreement" data-toggle="tab">Company Agreement</a></li>';
					...
					echo'<div class="tab-pane active" id="overview">';
						...
						echo'<div class="bs-callout bs-callout-primary">';
							...
							echo'<p>';
								...
								echo 'Your earnings snapshot and company information';
						...
						echo'<div class="tab-content row">';
							...
							echo'<div class="col-xs-12 col-sm-4">';
								...
								echo'<div class="panel panel-info text-info">';
									...
									$this->get_company_overview($this->parent->user->company_clicks);
							...
							echo'<div class="col-xs-12 col-sm-4">';
								...
								echo'<div class="panel panel-warning text-warning">';
									...
									$this->get_company_overview($this->parent->user->company_referrals);
							...
							echo'<div class="col-xs-12 col-sm-4">';
								...
								echo'<div class="panel panel-success text-success">';
									...
									$this->get_company_overview($this->parent->user->company_commission,true,'$');									
							...
							echo'<div class=" panel panel-default" style="margin-bottom:0;">';
								...
								echo'<tbody>';
									...
									echo'<tr style="font-size:18px;font-weight:bold;">';
										...
										echo'<td>' . $this->get_company_balance($this->parent->user->ID) . '</td>';
									echo'</tr>';
							...
							echo'<div class="panel-default">';
								...
								echo'<div id="collapse_'.$tab.'" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_'.$tab.'">';
									...
									echo'<div class="panel-body">';
										...
										echo 'As a member of this company program you are part of the team.'.PHP_EOL;
										echo '<br>';
								...
								echo'<div id="collapse_'.$tab.'" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_'.$tab.'">';
									...
									echo'<div class="panel-body">';
										...
										echo'<ul style="margin-left:10px;">';	
											...
											echo'<li>Please share your company discount through closed channels that you own and manage</li>'.PHP_EOL;
								...
								echo'<div id="collapse_'.$tab.'" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_'.$tab.'">';
									...
									echo'<div class="panel-body">';
										...
										echo'<ul style="margin-left:10px;">';	
											...
											echo'<li>You may not create or design your website or any other website that you operate, explicitly or implied in a manner which leads customers to believe you are "'.$company_name.'" or any other companyd business.'.PHP_EOL;
							...
							echo'<div class="panel-default">';
								...
								echo'<div id="collapse_'.$tab.'" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_'.$tab.'">';
									...
									echo'<div class="panel-body">';
										...
										echo'The Company Program permits you to monetize your website, social media user-generated content, or online software application (referred to here as your "Channels"), by placing links to '.$company_name.' website on your Channels.'.PHP_EOL;
										echo '<br><br>';
										...
										echo '<br><br>';
										echo'In order to facilitate your advertisement of Products, we may make available to you data, images, text, link formats, widgets, links, marketing content, and other linking tools, application program interfaces, and other information in connection with the Company Program ("Content").'.PHP_EOL;							
								...
								echo'<div id="collapse_'.$tab.'" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_'.$tab.'">';
									...
									echo'<div class="panel-body">';
										...
										echo'Our customers are not, by virtue of your participation in the Company Program, your customers.' . PHP_EOL;
										echo '<br><br>';
								...
								echo'<div id="collapse_'.$tab.'" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="heading_'.$tab.'">';
									...
									echo'<div class="panel-body">';
										...
										echo'<ul style="margin-left:10px;">';	
											...
											echo'<li>you will participate in the Company Program and create, maintain, and operate your Channels in accordance with this Agreement';
											...
											echo'<li>the information you provide in connection with the Company Program is accurate and complete at all times';
											
										echo'</ul>';	
											
										echo '<br>';
											
										echo'We do not make any representation, warranty, or covenant regarding the amount of traffic or fees you can expect at any time in connection with the Company Program, and we will not be liable for any actions you undertake based on your expectations.'.PHP_EOL;
								...
								echo'<div style="height:60px;border-bottom:1px solid #DDDDDD;" class="panel-heading" role="tab" id="heading_'.$tab.'">';
									...
									echo'<button style="color:rgb(138, 206, 236);background:none;text-align:left;font-size:21px;width: 100%;padding:8px;border:none;" role="button" data-toggle="collapse" data-parent="#agreement" data-target="#collapse_'.$tab.'" aria-expanded="true" aria-controls="collapse_'.$tab.'">';
										...
										echo'Identifying Yourself as an Company';
								...
								echo'<div id="collapse_'.$tab.'" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_'.$tab.'">';
									...
									echo'<div class="panel-body">';
										...
										echo'You must clearly state somewhere on your Channels that you are a participant in the '.$company_name.' Company Program, an company advertising program designed to provide a means to earn fees by linking to '.$company_name;										
								...
								echo'<div id="collapse_'.$tab.'" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_'.$tab.'">';
									...
									echo'<div class="panel-body">';
										...
										echo'The term of this Agreement will begin upon your registration on or use of the Company Site and will end when terminated by either you or us. ';
										echo '<br><br>';
								...
								echo'<div id="collapse_'.$tab.'" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_'.$tab.'">';
									...
									echo'<div class="panel-body">';
										...
										echo'Any dispute relating in any way to the Company Program or this Agreement will be resolved by binding arbitration, rather than in court, except that you may assert claims in small claims court if your claims qualify. ';
										echo'<br><br>';
								...
								*/
								...
								echo'<div id="collapse_'.$tab.'" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading_'.$tab.'">';
									...
									echo'<div class="panel-body">';
										...
										echo'<br><br>';
										echo'(a) sending you emails relating to the Company Program from time to time,'; 
										echo'<br>';
										...
										echo'<br><br>';										
										echo'In the event of any conflict between this Agreement and any Program Policy, this Agreement will control. This Agreement (including the Program Policies) is the entire agreement between you and us regarding the Company Program and supersedes all prior agreements and discussions.';
										echo'<br><br>';
										echo'All non-public information provided by us in connection with this Agreement or the Company Program is considered confidential information, and you will maintain the same in strict confidence and not disclose the same to any third party (other than your companys) or use the same for any purpose other than your performance under this Agreement, which restriction will be in addition to the terms of any confidentiality or non-disclosure agreement between the parties.';
										echo'<br><br>';
										echo'You and we are independent contractors, and nothing in this Agreement will create any partnership, joint venture, agency, franchise, sales representative, or employment relationship between you and us or our respective companys. You will have no authority to make or accept any offers or representations on our or our companys’ behalf. You will not make any statement, whether on your Channels or otherwise, that contradicts or may contradict anything in this paragraph. If you authorize, assist, encourage, or facilitate another person or entity to take any action related to the subject matter of this Agreement, you will be deemed to have taken the action yourself.	';									
